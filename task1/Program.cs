...
//Напишите программу которая считает сумму чисел от 1 до n. (1 и 2 тип алгоритмов)
...
//Бинарный поиск(двоичный поиск) второй тип алгоритма
...
// 7 попыток
// Сложность алгоритма бинарного поиска равен О(log2(n))
// log2(1000) ~ 10

// [12, 424, 235, 34, -5, 56, 6, 0, -123, 654, 34, 23], n  - это колличество элементов массива
// О(n * log2(n)) + O(log2(n))
...
// 2. Создается 2 массива. 1-й массив содержит элементы меньше опорного, 2-й массив содержит больше или равные опорному)
